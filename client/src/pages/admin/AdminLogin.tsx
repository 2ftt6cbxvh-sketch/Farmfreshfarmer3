          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className={`p-3.5 rounded-2xl border transition-all ${
                highlightTotp
                  ? "bg-purple-500/10 border-purple-500 shadow-lg shadow-purple-950/40 ring-2 ring-purple-500/30"
                  : "bg-secondary/40 border-card-border"
              }`}>
                <div className="flex items-center justify-between mb-1.5">
                  <Label htmlFor="admin-totp-code" className="text-xs font-bold flex items-center gap-1.5 text-foreground">
                ...
                <Input
                  ...
                  placeholder="• • • • • •"
                  className="rounded-xl font-mono text-center text-lg tracking-widest font-black h-11 bg-background/80"
