  ...
  return (
    <Layout>
      <div className="mx-auto max-w-3xl px-4 py-12">
        <LegalSubNav />
        <h1 className="font-serif text-2xl font-bold text-foreground mb-6" data-testid={`heading-${title}`}>
          {title}
        </h1>
        <div className="prose-policy space-y-4 text-sm leading-relaxed text-foreground/90">
          {children}
        </div>
      </div>
    </Layout>
...
/* ------------------------------------------------------------------ */
/* 1. Terms & Conditions (100% Verbatim PhonePe PDF Text)             */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* 2. Privacy Policy (100% Verbatim PhonePe PDF Text)                 */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* 3. Refund and Cancellation policy (100% Verbatim PhonePe PDF Text) */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* 4. Return Policy (100% Verbatim PhonePe PDF Text)                  */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* 5. Shipping Policy (100% Verbatim PhonePe PDF Text)                */
/* ------------------------------------------------------------------ */
