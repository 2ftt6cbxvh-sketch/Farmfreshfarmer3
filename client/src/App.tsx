  ...
  return (
    <ErrorBoundary>
      <Switch>
        ...
        {/* 🔒 Admin routes are NOT available on the public www domain.
             The admin portal is exclusively accessible via the private management subdomain.
             Any attempt to access /admin/* on www returns a standard 404. */}
