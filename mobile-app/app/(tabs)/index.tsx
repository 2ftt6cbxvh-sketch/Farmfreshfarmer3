      ...
      <Animated.View style={[styles.headerBg, isDark && styles.headerBgDark, { transform: [{ translateY: headerParallaxY }], paddingTop: insets.top + 12 }]}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            ...
            <View style={[styles.versionTag, { alignItems: 'center', justifyContent: 'center' }]}><Text style={styles.versionTagText}>v1.7.7</Text></View>
          </View>
...
const styles = StyleSheet.create({
  ...
  versionTagText: { color: '#34d399', fontSize: 10, fontWeight: '900' },
  ...
  deliveryLocationText: { flex: 1, marginRight: 8, color: '#38bdf8', fontWeight: '900', fontSize: 12.5, textShadowColor: 'rgba(56, 189, 248, 0.3)', textShadowOffset: {width: 0, height: 0}, textShadowRadius: 10 },
  ...
  etaBadgeText: { color: '#34d399', fontWeight: '800', fontSize: 11 },
  pincodePrompt: { color: '#34d399', fontSize: 13, marginTop: 6, fontStyle: 'italic' },
  ...
  categoryChipTextActive: { color: '#ffffff', fontWeight: '900' },
  ...
  modalInput: {
    ...
    padding: 16, fontSize: 20, textAlign: 'center', marginVertical: 20, fontWeight: '900', letterSpacing: 2,
  },
  ...
  gpsBtnText: { color: COLORS.text, fontWeight: '800', fontSize: 14 },
  ...
  bentoText: { fontSize: 12, color: '#fff', fontWeight: '800', letterSpacing: 0.5 },
});
