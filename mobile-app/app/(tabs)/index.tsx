...
export default function HomeScreen() {
  ...
  return (
    ...
    >
      ...
      <Animated.View style={[styles.headerBg, { transform: [{ translateY: headerParallaxY }] }]}>
        <Text style={styles.headerTitle}>🌿 {BRAND.name}</Text>
        <Text style={styles.headerSub}>Farm fresh delivered to your door</Text>
      </Animated.View>
      ...
      <Modal visible={pincodeModal} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalSub}>Enter your 6-digit PIN code to view nearby warehouse & delivery ETA</Text>
            <TextInput
            ...
            <View style={styles.modalBtnRow}>
              <TouchableOpacity style={styles.gpsBtn} onPress={() => { resolveByGps(); setPincodeModal(false); }}>
                <Text style={styles.gpsBtnText}>Use GPS 🛰️</Text>
              </TouchableOpacity>
